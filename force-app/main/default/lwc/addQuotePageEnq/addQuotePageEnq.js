...
import getEnqLineItems from '@salesforce/apex/AddQuotePageEnqController.getEnqLineItems';
import createQuote from '@salesforce/apex/AddQuotePageEnqController.createQuote';
...
export default class AddQuotePageEnq extends NavigationMixin(LightningElement) {
	cols = COLS;
