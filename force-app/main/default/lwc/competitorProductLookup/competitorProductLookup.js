...
import fetchLookupData from '@salesforce/apex/GetCompetitorProduct.fetchLookupData';
import fetchDefaultRecord from '@salesforce/apex/GetCompetitorProduct.fetchDefaultRecord';
export default class CompetitorProductLookup extends LightningElement {
    @api label = 'custom lookup label';
    @api placeholder = 'search...';
    @api iconName = 'standard:lead';
    @api sObjectApiName = 'Competitor_Product__c';
    @api defaultRecordId = '';
    @api recId;
    @api disabled;
    ...
    @wire(fetchLookupData, { searchKey: '$searchKey', sObjectApiName: '$sObjectApiName', recordId: '$recId' })
    searchResult(value) {
