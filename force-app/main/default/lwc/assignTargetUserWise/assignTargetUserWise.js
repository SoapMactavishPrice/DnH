...
export default class AssignTargetUserWise extends LightningElement {
    ...
    set empId(value) {
        ...
        if (this.parentTabLabel == 'User_Wise_Product_Category_Target__c') {
    ...
    getData() {
        ...
        if (this.childTabLabel == 'Yearly') {
            ...
            //     if (this.fiscId && this.empId && this.prodCatVal) {
            //         this.getYearlyData();
            //     }
            // }
            ...
            this.monthly = true;
            if (this.parentTabLabel != 'User_Wise_Product_Target__c') {
    ...
    onDataInput(event) {
        ...
        if (this.yearly) {
            ...
            this.data[index].isDataModified = this.data[index].Target_Quantity__c != this.data[index].Target_Amount_New__c ? true : false;
            ...
            childData.isDataModified = childData.Monthly_Target_Quantity__c != childData.Monthly_Target_Amount_New__c ? true : false;
        ...
        setTimeout(() => {
            if (this.newTargetValFlag > parseFloat(this.targetValFlag)) {
                this.dispatchEvent(new ShowToastEvent({
                    title: 'Error',
                    variant: 'error',
                    message: 'Assigned Qty (' + this.newTargetValFlag + ') cannot be greater then Target Amount (' + parseFloat(this.targetValFlag) + ')'
                }));
            }
    ...
    handleReset() {
        ...
        if (this.yearly) {
            this.records.forEach(item => {
                item.Target_Amount_New__c = item.Target_Quantity__c;
            ...
            this.records.forEach(item => {
                item.childData.forEach(monthItem => {
                    monthItem.Monthly_Target_Amount_New__c = monthItem.Monthly_Target_Quantity__c;
