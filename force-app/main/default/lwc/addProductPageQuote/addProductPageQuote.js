...
import getProducts from '@salesforce/apex/AddProductPageQuote.getProducts';
import getproductfamily from '@salesforce/apex/AddProductPageQuote.getproductfamily';
import getItemCategory from '@salesforce/apex/AddProductPageQuote.getItemCategory';
...
export default class AddProductPageQuote extends NavigationMixin(LightningElement) {
cols = COLS;
